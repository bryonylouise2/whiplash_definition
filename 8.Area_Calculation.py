...
## Output: Decadal CSV files (1 for drought-to-pluvial, 1 for pluvial-to-drought) that 
## have a list of all potential events throughout the time frame, including: Drought Date, 
