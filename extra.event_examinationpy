...
#########################################################################################
#Drought-to-Pluvial
DP_date = date(1938, 12, 18)
DP_index_spi = (DP_date - date(1915, 1, 1)).days
DP_index_whiplash = (DP_date - date(1915, 1, 1)).days
DP_index_density = (DP_date - date(1935, 1, 1)).days

#Pluvial-to-Drought
PD_date = date(1991, 9, 24)
PD_index_spi = (PD_date - date(1915, 1, 1)).days
PD_index_whiplash = (PD_date - date(1915, 1, 1)).days
PD_index_density = (PD_date - date(1988, 1, 1)).days
...
#########################################################################################
#Drought-to-Pluvial
df_spi_dp_drought = df_spi.spi_30day.isel(time=DP_index_spi)
df_spi_dp_pluvial = df_spi.spi_30day.isel(time=DP_index_spi+31)
df_whiplash_dp = df_whiplash.DP_whiplashes.isel(time=DP_index_whiplash)
df_density_dp = df_density_DP.DP_density.isel(time=DP_index_density)

#Pluvial-to-Drought
df_spi_pd_pluvial = df_spi.spi_30day.isel(time=PD_index_spi)
df_spi_pd_drought = df_spi.spi_30day.isel(time=PD_index_spi+31)
df_whiplash_pd = df_whiplash.PD_whiplashes.isel(time=PD_index_whiplash)
df_density_pd = df_density_PD.PD_density.isel(time=PD_index_density)
